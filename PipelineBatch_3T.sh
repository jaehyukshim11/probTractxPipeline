...
main()
{
	...
	Data="/data/hcp3t" # Location of Subject folders (named by subjectID)
	...
	FolderName="3T_Run"	#ProbtrackX Folder name in bedpostX folder
	...
	for Subject in ${Subjlist} ; do
		...
		Folder="${Data}/${Subject}/Diffusion_3T"
		echo $Folder
		...
		. ${ScriptFolder}/getwaypointtable.sh
